                    ...
                    steps {
                        ...
                        container('podman') {
                            script {
                                ...
                                sh 'cd backend'
                                webappBackPodman = sh 'podman build -t tpidevopsdespuesvemospublic-back .'
                                if (env.BRANCH_NAME == 'main') {
                    ...
                    steps {
                        ...
                        container('podman') {
                            script {
                                ...
                                sh 'cd frontend'
                                if (env.BRANCH_NAME == 'main') {
                                    webappFrontPodman = sh 'podman build -t tpidevopsdespuesvemospublic-front:${BUILD_NUMBER} --build-arg=STAGE=prod .'
